...
class EmotionModel:
    ...
    def __init__(self, model_name: str = "joeddav/distilbert-base-uncased-go-emotions-student", mode: str = "image"):
        """Create EmotionModel.
        ...
        self._onnx_model_url = 'https://huggingface.co/onnxmodelzoo/emotion-ferplus-8/resolve/main/emotion-ferplus-8.onnx'
    def load(self):
